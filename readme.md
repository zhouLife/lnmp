...
`git clone https://github.com/zhouLife/lnmp.git && cd lnmp && ./install.sh 
{lnmp|lnmpa|lamp}`
...
修改初始NGINX安装版本 需要修改 include/version.sh 代码中的 `Nginx_Ver='nginx-1.30.2'` 
修改自己想要安装的版本号 继续打开 lnmp/include/nginx.sh 
